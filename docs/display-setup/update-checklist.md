...
- Docked: connect `DP-1`, close the lid, and confirm active and occupied workspaces move while empty inactive workspaces disappear and `eDP-1` remains logically active with `actual_brightness` at zero.
